...
export default function sitemap(): MetadataRoute.Sitemap {
  const baseUrl = "https://skyeagletechno.shawanreddy.com";
  return [
    { url: baseUrl, lastModified: new Date(), changeFrequency: "weekly", priority: 1.0 },
    { url: `${baseUrl}/about`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.8 },
    { url: `${baseUrl}/services`, lastModified: new Date(), changeFrequency: "weekly", priority: 0.9 },
    { url: `${baseUrl}/data-recovery`, lastModified: new Date(), changeFrequency: "weekly", priority: 0.9 },
    { url: `${baseUrl}/refurbished-products`, lastModified: new Date(), changeFrequency: "weekly", priority: 0.9 },
